...
<body id="principal">
  <%
    ...
    request.setCharacterEncoding("UTF-8");
        ...
        s.execute ("DELETE FROM enemigo WHERE CodEne=" + request.getParameter("borrar"));
        conexion.close();
    %>
    
    <div id="wrapper" class="container p-4 my-5 text-light">
        <div class="text-center bg-dark py-5 px-1">
            <img src="./images/icon.jpg">
            <h4 class="mt-5">Los datos del enemigo han sido eliminados con éxito de forma permanente</h4>
